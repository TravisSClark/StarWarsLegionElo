...
def main():
    # update_recent_elos("2022-11-01 12:00:00", "2024-02-20 01:00:00")
    # update_recent_elos("2023-12-04 01:00:00", "2024-02-20 01:00:00")
    players = db.get_all()
    weightedPlayers = db.get_all_sorted("weighted_elo")
    with open("resources/response/getAll.json", "w", encoding='utf8') as file:
        file.write("[\n")
        ...
        file.write("{}\n]")
        players = db.get_all()
    with open("resources/response/getAllWeighted.json", "w", encoding='utf8') as file:
        file.write("[\n")
